...
//#if defined(DOD_DLL) || defined(CSTRIKE_DLL) // BOXBOX enabling this for MSS!
...
ConVar cl_detaildist( "cl_detaildist", "2400", 0, "Distance at which detail props are no longer visible" ); // BOXBOX was 1200
